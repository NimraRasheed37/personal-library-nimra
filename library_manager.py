...
class BookCollection:
    ...
    def remove_book(self):
        ...
        book_title = input("Enter the title of the book you want to remove from your library: ")
    ...
    def search_book(self):
        """Search for books in the collection by title or author's name."""
    ...
    def update_book(self):
        """Modify the details of an existing book in your library"""
    ...
    def start_application(self):
        """Run the main application with a user-friendly menu interface."""
        while True:
            print("\n☺️  Hi Nimra! 📚 Welcome to your Personal Library Manager!📚\n")
